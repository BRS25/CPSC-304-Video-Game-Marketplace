...
<body>
	<label><p>Welcome to AGORA</p></label>
	<br><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="submit" name="init" value="initilize" >
...
if ($db_conn) {
	...
	if (array_key_exists('ulogin', $_POST)) {
		...
		/*
			...
			setcookie("username", $user);
			//header("location:http://www.ugrad.cs.ubc.ca/~k0a0b/main.php");
...
VALUES     ('Mario', '11', 'false', 'false', 'Sonic the Hedgehog', 99, 'Vancouver', TO_DATE('2017-05-08', 'yyyy-mm-dd'))");
					executePlainSQL("INSERT
INTO          Listings_Post(username, listingID, Active, Selling, Title, Price, Location, DatePosted)
VALUES     ('Dante', '12', 'true', 'true', 'Xbox 360 Controller', 40, 'Richmond', TO_DATE('2017-12-24', 'yyyy-mm-dd'))");
					executePlainSQL("INSERT
INTO          Listings_Post(username, listingID, Active, Selling, Title, Price, Location, DatePosted)
