...
?>
	...
	<label><br><br><p>Create a selling listing</p></label>
	<br><br>
...
if ($db_conn) {
	...
	if (array_key_exists('create', $_POST)) {
		...
		executePlainSQL("insert into Listings_Post values ('$login', '$newlistingid','true','true','$title',$price,'$location','$today')");
